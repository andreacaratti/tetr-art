...
class Lvl4Kanagawa(level):
    ...
    def load_image(self):
        level_image_path = path.join(base_path,"data","img","levels","lvl4_Kanagawa_Pixel.png")
        image = pygame.image.load(level_image_path).convert()
        self.split_image(image=image)

        level_preview_path = path.join(base_path,"data","img","levels","lvl4_Kanagawa_Pixel.png")
